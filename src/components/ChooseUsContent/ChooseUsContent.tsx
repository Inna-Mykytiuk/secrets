...
const ChooseUsContent = () => {
  return (
    <div className='flex flex-col'>
      <h3 className='text-white hidden font-extralight lg:flex lg:text-4xl lg:leading-10 uppercase lg:ml-[143px] lg:mb-[45px]'>Why Us ?</h3>
      <ul className='flex flex-col gap-6 gap-y-4 mr-[90px] text-right sm:w-[14.0625rem] sm:float-left sm:mr-[28px] sm:gap-y-6 lg:w-full lg:mr-0  sm:mb-0'>
